...
1. [概要](#概要)
2. [引当推奨機能（ソフトアロケーション）仕様書 v2.0](#引当推奨機能ソフトアロケーション仕様書-v20)
3. [Allocation Suggestion Design（最終版）](#allocation-suggestion-design最終版)
4. [ロット引当ページ UI改善仕様書【統合版】](#ロット引当ページ-ui改善仕様書統合版)
