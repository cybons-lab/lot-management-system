...
| フェーズ | 内容 | ステータス |
|---------|------|----------|
| 1. DDL/マイグレーション | `origin_type`, `origin_reference`カラム追加 | [ ] 未着手 |
| 2. モデル・スキーマ | Lotモデル/スキーマにカラム追加 | [ ] 未着手 |
| 3. サービス層 | バリデーション緩和、採番ユーティリティ | [ ] 未着手 |
| 4. API拡張 | アドホックロット作成エンドポイント | [ ] 未着手 |
| 5. フロントエンド | 作成フォーム、一覧表示 | [ ] 未着手 |
| 6. FEFO引当 | origin_typeフィルタ（将来対応） | [ ] 未着手 |
| 7. テスト | ユニット/統合テスト | [ ] 未着手 |

> [!NOTE]
> 詳細タスクリストは実装計画レビュー後に確定予定
