...
def test_regenerate_for_periods(db_session):
    ...
    supplier = Supplier(
        supplier_code="SUP1", supplier_name="Supplier 1"
    )
    db_session.add(supplier)
    
    customer = Customer(
        customer_code="CUST1", customer_name="Customer 1"
    )
    ...
    product = Product(
        maker_part_code="PROD1", product_name="Product 1", base_unit="EA"
    )
...
def test_regenerate_with_shortage(db_session):
    ...
    supplier = Supplier(
        supplier_code="SUP2", supplier_name="Supplier 2"
    )
    db_session.add(supplier)
    
    customer = Customer(
        customer_code="CUST2", customer_name="Customer 2"
    )
    db_session.add(customer)
    ...
    product = Product(
        maker_part_code="PROD2", product_name="Product 2", base_unit="EA"
    )
    db_session.add(product)
    db_session.commit()
