"""add_error_flags_to_v_ocr_results

Revision ID: a32530da9211
Revises: e218bf23049b
Create Date: 2026-01-26 14:52:51.740081
...
revision = "a32530da9211"
down_revision = "e218bf23049b"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # 前の定義に戻す必要があるが、大差ないので簡易的にDROPのみか、a1b2c3d4e5f6の内容に戻す
    op.execute("DROP VIEW IF EXISTS public.v_ocr_results CASCADE")
