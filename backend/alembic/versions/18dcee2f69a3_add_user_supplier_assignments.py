...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["supplier_id"],
            ["suppliers.id"],
            name="fk_user_supplier_assignments_supplier",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="fk_user_supplier_assignments_user", ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "idx_user_supplier_assignments_supplier", "user_supplier_assignments", ["supplier_id"]
    )
    op.create_index(
