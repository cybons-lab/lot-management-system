...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_system_client_logs_created_at", "system_client_logs", ["created_at"], unique=False
    )
    op.create_index(
        "idx_system_client_logs_user_id", "system_client_logs", ["user_id"], unique=False
    )
