...
def upgrade() -> None:
    ...
    op.add_column(
        "lots", sa.Column("locked_quantity", sa.Numeric(15, 3), nullable=False, server_default="0")
    )

    # 2. Add check constraint for locked_quantity >= 0
    op.create_check_constraint(
        "chk_lots_locked_quantity", "lots", sa.column("locked_quantity") >= 0
    )
    ...
    op.create_check_constraint(
        ...
        "lots",
        sa.column("allocated_quantity") + sa.column("locked_quantity")
