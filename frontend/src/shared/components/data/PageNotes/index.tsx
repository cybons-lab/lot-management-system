...
export function PageNotes({
  ...
  return (
    <div
      className={cn("border border-blue-200 rounded-lg bg-blue-50/30 overflow-hidden", className)}
    >
      <button
        type="button"
      ...
      >
        ...
        {value && (
          <span className="text-xs text-blue-600 bg-blue-100 px-2 py-0.5 rounded">入力あり</span>
        )}
        <span className="ml-auto text-slate-400 text-sm">{isExpanded ? "▲" : "▼"}</span>
      </button>
      {isExpanded && (
