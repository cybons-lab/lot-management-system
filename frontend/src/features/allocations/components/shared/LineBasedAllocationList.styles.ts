...
// グルーピングトグル
export const groupingToggleContainer = "ml-auto flex items-center gap-2 border-l border-gray-300 pl-4";
...
export const orderCard = (isChecked: boolean) =>
    `group/order mb-6 overflow-hidden rounded-xl border transition-all duration-300 ${isChecked
...
export const orderCardHeader = (isChecked: boolean) =>
    `flex items-center justify-between px-6 py-3 ${isChecked ? "border-none bg-green-50/80" : "border-b border-gray-200 bg-gray-50"
    }`;
...
// グルーピング表示用
export const groupHeaderContainer = "mb-4 rounded-lg border border-blue-200 bg-blue-50/50 p-4 shadow-sm";
