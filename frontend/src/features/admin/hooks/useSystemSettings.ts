...
export function useSystemSettings() {
    ...
    const [viewCheckStatus, setViewCheckStatus] = useState<"idle" | "checking" | "ok" | "error">("idle");
    ...
    // Schema Check state
    const [schemaCheckStatus, setSchemaCheckStatus] = useState<"idle" | "checking" | "ok" | "warning" | "error">("idle");
