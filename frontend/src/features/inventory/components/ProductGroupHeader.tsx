...
export function ProductGroupHeader({
    ...
    return (
        <div
            className="flex cursor-pointer items-center gap-4 bg-gray-100 px-4 py-3 hover:bg-gray-200 font-medium"
            onClick={onToggle}
        >
            ...
            <div className="flex-1 grid grid-cols-5 gap-4">
                ...
                <div className="col-span-1">
                    ...
                    <div className="font-medium truncate" title={supplierName}>{supplierName}</div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    {minExpiryDate && (
                        <div>
                            ...
                            <div className="font-medium text-sm">{minExpiryDate}</div>
                        </div>
                    )}
                </div>
            </div>
