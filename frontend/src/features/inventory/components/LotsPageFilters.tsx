            ...
            {isAdvancedOpen && (
                <div className="grid grid-cols-1 gap-4 rounded-lg border border-slate-200 bg-slate-50/50 p-4 md:grid-cols-4">
                    <div className="space-y-2">
                        <label htmlFor="product-code-filter" className="text-sm font-medium">製品コード</label>
                        <Input
                    ...
                    <div className="space-y-2">
                        <label htmlFor="warehouse-code-filter" className="text-sm font-medium">倉庫コード</label>
                        <Input
