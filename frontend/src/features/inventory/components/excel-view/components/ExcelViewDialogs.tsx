...
import { AllocationTransfer } from "@/features/inventory/api";
import { ExcelViewData } from "../types";
...
interface ExcelViewDialogsProps {
    ...
    onSmartSplitConfirm: (lotId: number, transfers: AllocationTransfer[], splitCount: number) => Promise<void>;
