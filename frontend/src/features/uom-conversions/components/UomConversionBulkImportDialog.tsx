                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-slate-500">
                            ※ヘッダー行が必要です: OPERATION, product_code, product_name, external_unit, conversion_factor, remarks
                        </p>
                    </div>
                                    ...
                                    <table className="min-w-full divide-y divide-slate-200">
                                        <thead className="bg-slate-50 sticky top-0">
                                            <tr>
                                                ...
                                                <th className="px-3 py-2 text-left text-xs font-medium text-slate-500 uppercase">外部単位</th>
                                                <th className="px-3 py-2 text-left text-xs font-medium text-slate-500 uppercase">換算係数</th>
                                            </tr>
                                        </thead>
                                        <tbody className="bg-white divide-y divide-slate-200">
                                            {previewRows.slice(0, 100).map((row, i) => (
                                                <tr key={i}>
                                                    ...
                                                    <td className="px-3 py-2 text-xs text-slate-500">{row.conversion_factor}</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
