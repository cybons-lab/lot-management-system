...
function OrderCardHeader({ displayCode, order, onReMatch }: OrderCardHeaderProps) {
  return (
...
interface OrderLinesTableProps {
  lines: OrderWithLinesResponse["lines"];
  onSelectLine?: (orderLineId: number) => void;
}

function OrderLinesTable({ lines, onSelectLine }: OrderLinesTableProps) {
  return (
    <div className="mt-3">
