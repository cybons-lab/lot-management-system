...
export const cardHeader = "mb-3 flex items-center gap-2";
...
export const infoRow = "flex items-center justify-between text-xs";

export const infoLabel = "text-gray-600";
...
export const lotCount = "ml-1 text-gray-500";

export const inboundList = "mt-1 space-y-0.5";

export const inboundItem = "flex items-center gap-2 text-xs text-gray-700";
...
export const detailButton = "mt-3 h-7 w-full bg-white text-xs hover:bg-blue-50";
