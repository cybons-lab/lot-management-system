...
export interface paths {
  ...
  "/api/v2/withdrawals/default-destination": {
     ...
     * @description 仕入先品目IDからデフォルトの得意先・納入先を取得する.
     *
...
export interface components {
  schemas: {
    ...
    BatchJobCreate: {
       ...
       */
      parameters?: Record<string, unknown> | Record<string, unknown> | null;
    };
    /**
    ...
    BusinessRuleUpdate: {
       ...
       * @description ルールパラメータ（JSON）
       */
      rule_parameters?: Record<string, unknown> | null;
      /**
       * Is Active
       * @description 有効フラグ
       */
    ...
    InboundPlanReceiveRequest: {
      ...
      received_at: string;
      /** Lot Numbers */
      lot_numbers?: Record<string, string> | null;
    };
    /**
    ...
    MaterialOrderForecastResponse: {
      ...
      /** Daily Quantities */
      daily_quantities?: Record<string, unknown> | null;
      /** Period Quantities */
      period_quantities?: Record<string, unknown> | null;
      /**
       * Snapshot At
       * Format: date-time
       */
    ...
    OcrResultItem: {
      ...
      /** Sap Raw Data */
      sap_raw_data?: Record<string, unknown> | null;
      /** Error Flags */
      error_flags?: Record<string, boolean>;
    ...
    PublicSystemSettings: {
      /** Page Visibility */
      page_visibility: Record<string, unknown> | null;
      /** Maintenance Mode */
  ...
  clear_cache_api_integration_sap_materials_cache_delete: {
    ...
    responses: {
      ...
      200: {
        headers: Record<string, unknown>;
        content: {
          "application/json": Record<string, string | number>;
        };
      };
      /** @description Validation Error */
      422: {
